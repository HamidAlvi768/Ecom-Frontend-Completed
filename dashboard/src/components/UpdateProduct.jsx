...
export const UpdateProduct = () => {
  ...
  useEffect(() => {
    ...
    const fetchProductData = async () => {
      try {
        const productId = ''; // Add logic to get the product ID
        ...
        <div className="flex items-center justify-center w-full">
          ...
          <label htmlFor="image-upload" className={photo ? 'file-upload-label uploaded-label' : 'file-upload-label'}>
            <div className="file-upload-content">
              {photo ? <img className="upload-icon uploaded-image" src={URL.createObjectURL(photo)} alt="" /> : <img className="upload-icon uploaded-image" src={formData.image} alt="" /> }
            </div>
